...
+(NSString *)getWeekDay:(NSString *)string{
    string = [TimeChange timeChage:[string substringToIndex:string.length - 3]];
    NSString *mString = [string substringFromIndex:4];
    NSArray *array = [mString componentsSeparatedByString:@" "];
    mString = [array objectAtIndex:0];
    string = [NSString stringWithFormat:@"%@%@%@",[string substringToIndex:4],[mString substringToIndex:3],[mString substringFromIndex:3]];
    ...
    NSString *weekDayString = [arrWeek objectAtIndex:week - 1];
    return weekDayString;
}

+(NSDictionary*)getMondayWeekday:(NSString*)string{
    NSString *mString = [string substringFromIndex:4];
