...
-(void)setMainView{
    ...
    for (int i = 0; i < 21; i++) {
        ...
        [btn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"[p%d].png",i]] forState:UIControlStateNormal];
        btn.tag = i;
    ...
    for (int i = 21; i < 42; i++) {
        ...
        if (i == 34) {
            [btn setImage:[UIImage imageNamed:@"[p107].png"] forState:UIControlStateNormal];
            btn.tag = 107;
        }
    }
    ...
    for (int i = 63; i < 84; i++) {
        ...
        if (i == 69) {
            [btn setImage:[UIImage imageNamed:@"[p108].png"] forState:UIControlStateNormal];
            btn.tag = 108;
        }
    }
    ...
    for (int i = 84; i < 105; i++) {
        ...
        if (i == 104) {
            [btn setImage:[UIImage imageNamed:@"[p109].png"] forState:UIControlStateNormal];
            btn.tag = 109;
        }
    }
...
-(void)setMainView2{
    ...
    [firstBtn setImage:[UIImage imageNamed:@"auth_follow_cb_unc.png"] forState:UIControlStateNormal];
    [firstBtn setImage:[UIImage imageNamed:@"auth_follow_cb_chd.png"] forState:UIControlStateSelected];
