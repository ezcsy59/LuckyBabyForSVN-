...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        [btn setImage:[UIImage imageNamed:@"auth_follow_cb_unc.png"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"auth_follow_cb_chd.png"] forState:UIControlStateSelected];
