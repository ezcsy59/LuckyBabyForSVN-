            ...
            for (UIButton *btn in self.btnArray) {
                if (btn.tag == photoBtn.tag) {
                    ...
                    if (btn.selected == YES) {
                        ...
                        yesImageV.tag = 10001;
                        yesImageV.image = [UIImage imageNamed:@"album_check.png"];
...
-(void)selectBtnClick:(int)tag{
    if (tag == 0) {
        ...
        if (self.editingFootBar == nil) {
            ...
            quxiaoBtn.backgroundColor = [UIColor clearColor];
            [quxiaoBtn setImage:[UIImage imageNamed:@"album_quit.png"] forState:UIControlStateNormal];
            ...
            quedingBtn.backgroundColor = [UIColor clearColor];
            [quedingBtn setImage:[UIImage imageNamed:@"album_delete.png"] forState:UIControlStateNormal];
