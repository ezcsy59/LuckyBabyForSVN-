...
//        btn.backgroundColor = [UIColor yellowColor];
        ...
        if ([[DictionaryStringTool stringFromDictionary:dic forKey:@"appType"]integerValue] == 1) {
            switch (i) {
                case 0:
                {
                    [btn setImage:[UIImage imageNamed:@"notice.png"] forState:UIControlStateNormal];
                    label.text = @"发部门通知";
                }
                    break;
                case 1:
                ...
                case 2:
                {
                    [btn setImage:[UIImage imageNamed:@"ico_home_teach.png"] forState:UIControlStateNormal];
                    label.text = @"幼儿出勤";
                }
                    break;
                case 3:
                {
                    [btn setImage:[UIImage imageNamed:@"trends.png"] forState:UIControlStateNormal];
                    label.text = @"疾病趋势";
                }
                    break;
                case 4:
                {
                    [btn setImage:[UIImage imageNamed:@"cookbook_img.png"] forState:UIControlStateNormal];
                    label.text = @"食谱";
                }
                    break;
                case 5:
                {
                    [btn setImage:[UIImage imageNamed:@"teach_photo_icon.png"] forState:UIControlStateNormal];
                    label.text = @"班级相册";
                }
                    break;
                case 6:
                {
                    [btn setImage:[UIImage imageNamed:@"teach_class_circle_icon.png"] forState:UIControlStateNormal];
                    label.text = @"班级圈";
                }
                    break;
                case 7:
                {
                    [btn setImage:[UIImage imageNamed:@"class_schedule.png"] forState:UIControlStateNormal];
                    label.text = @"课表";
                }
                    break;
                case 8:
            ...
            switch (i) {
                ...
                case 3:
                {
                    [btn setImage:[UIImage imageNamed:@"teach_childshow_icon.png"] forState:UIControlStateNormal];
                    label.text = @"本周表现";
                }
                    break;
                case 4:
                {
                    [btn setImage:[UIImage imageNamed:@"teach_month_icon.png"] forState:UIControlStateNormal];
                    label.text = @"本月评价";
                }
                    break;
                case 5:
                {
                    [btn setImage:[UIImage imageNamed:@"teach_endterm_icon.png"] forState:UIControlStateNormal];
                    label.text = @"学期评价";
                }
                    break;
                case 6:
