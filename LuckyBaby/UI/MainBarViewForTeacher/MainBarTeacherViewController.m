    ...
    for (int i = 0; i < 4; i++) {
        ...
        switch (i) {
            case 0:
                ...
                [tabButton setImage:[UIImage imageNamed:@"teacher_footb_a1.png"] forState:UIControlStateNormal];
                [tabButton setImage:[UIImage imageNamed:@"teacher_footb_b1.png"] forState:UIControlStateSelected];
            ...
            case 1:
                ...
                [tabButton setImage:[UIImage imageNamed:@"teacher_footb_a2.png"] forState:UIControlStateNormal];
                [tabButton setImage:[UIImage imageNamed:@"teacher_footb_b2.png"] forState:UIControlStateSelected];
                [tabButton setImageEdgeInsets:UIEdgeInsetsMake(8, 25, 21, 25)];
                [tabButton setTitleEdgeInsets:UIEdgeInsetsMake(40, -70, 0, 0)];
                break;
            case 2:
                [tabButton setTitle:@"通讯录" forState:UIControlStateNormal];
                [tabButton setImage:[UIImage imageNamed:@"teacher_footb_a3.png"] forState:UIControlStateNormal];
                [tabButton setImage:[UIImage imageNamed:@"teacher_footb_b3.png"] forState:UIControlStateSelected];
                [tabButton setImageEdgeInsets:UIEdgeInsetsMake(8, 25, 21, 25)];
                [tabButton setTitleEdgeInsets:UIEdgeInsetsMake(40, -70, 0, 0)];
                break;
            case 3:
                [tabButton setTitle:@"更多" forState:UIControlStateNormal];
                [tabButton setImage:[UIImage imageNamed:@"teacher_footb_a4.png"] forState:UIControlStateNormal];
                [tabButton setImage:[UIImage imageNamed:@"teacher_footb_b4.png"] forState:UIControlStateSelected];
                [tabButton setImageEdgeInsets:UIEdgeInsetsMake(8, 25, 21, 25)];
                [tabButton setTitleEdgeInsets:UIEdgeInsetsMake(40, -70, 0, 0)];
                break;
            default:
