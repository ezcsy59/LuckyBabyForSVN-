...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0) {
        ...
        image.image = [UIImage imageNamed:@"yuandian_01.png"];
    ...
    if (indexPath.row == 1) {
        ...
        HJHMyImageView *image = [[HJHMyImageView alloc]init];
        image.frame = CGRectMake(10, 10, 20, 20);
        image.image = [UIImage imageNamed:@"yuandian_02.png"];
        [cell addSubview:image];
    }
    if (indexPath.row == 2) {
        nameLabel.text = @"午餐";
        ...
        HJHMyImageView *image = [[HJHMyImageView alloc]init];
        image.frame = CGRectMake(10, 10, 20, 20);
        image.image = [UIImage imageNamed:@"yuandian_03.png"];
        [cell addSubview:image];
    }
    if (indexPath.row == 3) {
        nameLabel.text = @"下午点心";
        ...
        HJHMyImageView *image = [[HJHMyImageView alloc]init];
        image.frame = CGRectMake(10, 10, 20, 20);
        image.image = [UIImage imageNamed:@"yuandian_04.png"];
        [cell addSubview:image];
    }
    if (indexPath.row == 4) {
        nameLabel.text = @"晚餐";
        ...
        HJHMyImageView *image = [[HJHMyImageView alloc]init];
        image.frame = CGRectMake(10, 10, 20, 20);
        image.image = [UIImage imageNamed:@"yuandian_05.png"];
        [cell addSubview:image];
    }
...
-(void)swipReturnDate1:(NSString *)date1 date2:(NSString *)date2{
    self.currentDay = 0;
    NSDictionary *dic = [TimeChange getMondayWeekday:date1];
    self.dateDic = dic;
    [self getData];
}
