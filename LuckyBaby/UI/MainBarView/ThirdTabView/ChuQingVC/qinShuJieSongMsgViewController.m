...
-(void)setFootMainView{
    ...
    [self.header_babyBtn setImageWithURL:[NSURL URLWithString:[DictionaryStringTool stringFromDictionary:self.msgDic forKey:@"accompanyPhoto"]] placeholderImage:[UIImage imageNamed:@"addPhoto.png"]];
