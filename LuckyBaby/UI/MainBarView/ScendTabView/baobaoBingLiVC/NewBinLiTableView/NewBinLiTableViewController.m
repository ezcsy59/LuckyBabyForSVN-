...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 4) {
        ...
        [voiceBtn setImage:[UIImage imageNamed:@"record.png"] forState:UIControlStateNormal];
        ...
        [self.voicePlayBtn setImage:[UIImage imageNamed:@"voice1.png"] forState:UIControlStateNormal];
        ...
        [self.voiceDeleBtn setImage:[UIImage imageNamed:@"voice1_del.png"] forState:UIControlStateNormal];
        ...
        [emojiBtn setImage:[UIImage imageNamed:@"emotion.png"] forState:UIControlStateNormal];
    ...
    if (indexPath.row == 5) {
        for (int i = 0; i < self.photoSmallImageArray.count + 1; i ++) {
            if (i == self.photoSmallImageArray.count) {
                ...
                [deleBtn setImage:[UIImage imageNamed:@"umeng_update_close_bg_tap.png"] forState:UIControlStateNormal];
...
-(void)addData{
    if(!(self.timeTextField.text.length > 0 && self.nameTextField.text.length > 0 && self.mainTextView.text.length > 0)){
    ...
    sendPhotoI = 0;
    isSmallPhone = NO;
    if (self.photoBigImageArray.count > 0) {
        ...
        [jianK saveDiseaseWithChildIdFamily:[DictionaryStringTool stringFromDictionary:dic forKey:@"childIdFamilyCurrent"] diseaseType:self.nameTextField.text diseaseDesc:string voiceUrl:@"" videoUrl:@"" imageList:@[]];
    }
}
