...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 3) {
        ...
        [self.selectBtn1 setImage:[UIImage imageNamed:@"auth_follow_cb_unc.png"] forState:UIControlStateNormal];
        [self.selectBtn1 setImage:[UIImage imageNamed:@"auth_follow_cb_chd.png"] forState:UIControlStateSelected];
    ...
    if (indexPath.row == 5) {
        ...
        [self.selectBtn2 setImage:[UIImage imageNamed:@"auth_follow_cb_unc.png"] forState:UIControlStateNormal];
        [self.selectBtn2 setImage:[UIImage imageNamed:@"auth_follow_cb_chd.png"] forState:UIControlStateSelected];
