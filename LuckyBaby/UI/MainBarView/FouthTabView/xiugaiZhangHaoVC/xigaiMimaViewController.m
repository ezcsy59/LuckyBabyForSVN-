...
//    [self.textImageView addSubview:Layer4];
    ...
    self.userIdField = [[HJHMyTextField alloc]initWithFrame:CGRectMake(90, 1+ 200, 200, 48) andFromRight:10];
    ...
    self.userIdField2 = [[HJHMyTextField alloc]initWithFrame:CGRectMake(90, 1+ 250, 200, 48) andFromRight:10];
