...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if([[dic objectForKey:@"locationName"] isKindOfClass:[NSString class]]){
    ...
    if([[dic objectForKey:@"locationAdress"] isKindOfClass:[NSString class]]){
        locationAdress = [dic objectForKey:@"locationAdress"];
    }
    diDianLabel.text = [NSString stringWithFormat:@"[p1000]%@",locationAdress];
    ...
    if([[dic objectForKey:@"locationPhone"] isKindOfClass:[NSString class]]){
        locationPhone = [dic objectForKey:@"locationPhone"];
    }
    phoneLabel.text = [NSString stringWithFormat:@"[p1002]%@",locationPhone];
    ...
    NSString *distance = @"";
    if([[dic objectForKey:@"locationDistance"] isKindOfClass:[NSString class]]){
        distance = [dic objectForKey:@"locationDistance"];
    }
