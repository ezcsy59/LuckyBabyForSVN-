...
-(void)leftBtnClick{
    ...
    [self.delegate2 leftBtnClick:haveMan recId:self.leftRec nickName:self.leftLabel1.text relativesNickname:self.leftRelativesNickname];
}
...
-(void)rightBtnClick{
    ...
    [self.delegate2 rightBtnClick:haveMan recId:self.RightRec nickName:self.rightLabel1.text relativesNickname:self.rightRelativesNickname];
}
