...
-(id)initWithRecId:(NSString*)RecId nickName:(NSString*)nickName relativesNickname:(NSString*)relativesNickname{
    if (self = [super init]) {
        self.RecId = RecId;
        self.nickName = nickName;
        self.relativesNickname = relativesNickname;
    }
    return self;
}
...
-(void)setMainView{
    ...
    self.textField5.text = self.relativesNickname;
