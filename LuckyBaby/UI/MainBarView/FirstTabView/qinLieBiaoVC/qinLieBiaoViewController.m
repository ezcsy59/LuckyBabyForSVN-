    ...
    if (indexPath.row == 0) {
        ...
        for (int i = 0; i < self.followQinListArray.count; i++) {
            ...
            if ([[DictionaryStringTool stringFromDictionary:dic forKey:@"relationsName"] isEqualToString:@"妈妈"]) {
                ...
                qCell.leftRelativesNickname = [DictionaryStringTool stringFromDictionary:dic forKey:@"relativesNickname"];
                ...
                qCell.rightRelativesNickname = [DictionaryStringTool stringFromDictionary:dic forKey:@"relativesNickname"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row >= 2) {
        ...
        NSString *relativesNickname = [DictionaryStringTool stringFromDictionary:dic forKey:@"relativesNickname"];
        qinMessageViewController *yVC = [[qinMessageViewController alloc]initWithRecId:recId nickName:nickName relativesNickname:relativesNickname];
...
-(void)leftBtnClick:(BOOL)haveMan recId:(NSString *)recId nickName:(NSString *)nickName relativesNickname:(NSString *)relativesNickname{
    if (haveMan) {
        qinMessageViewController *yVC = [[qinMessageViewController alloc]initWithRecId:recId nickName:nickName relativesNickname:relativesNickname];
        [self.navigationController pushViewController:yVC animated:YES];
    }
...
-(void)rightBtnClick:(BOOL)haveMan recId:(NSString *)recId nickName:(NSString *)nickName relativesNickname:(NSString *)relativesNickname{
    if (haveMan) {
        qinMessageViewController *yVC = [[qinMessageViewController alloc]initWithRecId:recId nickName:nickName relativesNickname:relativesNickname];
        [self.navigationController pushViewController:yVC animated:YES];
    }
