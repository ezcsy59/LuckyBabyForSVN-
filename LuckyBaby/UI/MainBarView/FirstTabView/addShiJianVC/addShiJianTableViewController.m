...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.row == 1){
        ...
        [firsttimeBtn setImage:[UIImage imageNamed:@"firsttime.png"] forState:UIControlStateNormal];
    ...
    if(indexPath.row == 3){
        ...
        [self.videoBtn setImage:[UIImage imageNamed:@"video_record.png"] forState:UIControlStateNormal];
    ...
    if(indexPath.row == 4){
        ...
        rightImage.image = [UIImage imageNamed:@"right_icon.png"];
