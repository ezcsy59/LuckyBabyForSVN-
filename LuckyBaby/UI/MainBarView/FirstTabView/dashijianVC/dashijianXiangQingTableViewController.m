...
@interface dashijianXiangQingTableViewController ()<UITableViewDataSource,UITableViewDelegate,DaShiJianTableViewCellDelegate2>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (!cell) {
        cell = [[DaShiJianTableViewCell2 alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
    }
    [cell setSelectionStyle:UITableViewCellSelectionStyleNone]; 
    DaShiJianTableViewCell2 *qCell = (DaShiJianTableViewCell2*)cell;
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    DaShiJianTableViewCell2 *qCell=  [[DaShiJianTableViewCell2 alloc]init];
...
-(void)photoBtnClickWithNumberIndexRow:(NSString *)numberIndexRow andTag:(int)tag{
    showBigPhotoViewController *sVC = [[showBigPhotoViewController alloc]initWithPhotoA:[DictionaryStringTool stringFromDictionary:self.xiangQingDic forKey:@"imageList"] andTab:tag isLocationPhoto:NO isClassShow:YES];
